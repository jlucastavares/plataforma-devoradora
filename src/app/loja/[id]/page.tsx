            ...
            <div className="border-t border-white/10 pt-8 mt-auto">
              ...
              {product.stock > 0 ? (
                <div className="flex flex-col gap-4">
                  ...
                  <button className="w-full bg-neon-orange text-white py-4 rounded-xl font-black uppercase tracking-widest text-lg hover:shadow-[0_0_30px_rgba(255,107,0,0.3)] active:scale-[0.98] transition-all">
